...
export default function Footer() {
  return (
    <div className=' bottom-0 z-50  w-full p-3   flex bg-slate-200'>
      <footer className='flex items-center  w-full justify-between '>
        <aside className='flex items-center gap-4 justify-between p-4'>
          <svg
